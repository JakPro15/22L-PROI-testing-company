...
{
    Producer pr;
    RolePlayingGame game(30001, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500));
    SECTION("Constructors and getters - typical")
    {
        // Construction from Price object
        RolePlayingGame game1(30001, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500));
        CHECK(game1.getId() == 30001);
        ...
        RolePlayingGame game2(39999, "            TYYY", pr, 10000, AbstractGame::Complex, 1, 150, 250, false, 500);
        CHECK(game2.getId() == 39999);
        ...
        RolePlayingGame game3(30001, "G a a", pr, 234, AbstractGame::Simple, 23, 100, 100, true, 5, 12);
        CHECK(game3.getId() == 30001);
    ...
    {
        CHECK_THROWS_AS(
            RolePlayingGame(30000, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500)), InvalidId
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30000, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500)), InvalidId
        );
        CHECK_THROWS_AS(
            RolePlayingGame(40000, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, 5, 0), InvalidId
        );
        CHECK_THROWS_AS(
            RolePlayingGame(40000, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, 5, 0), InvalidId
        );
        ...
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500)), InvalidTitle
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "  ", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500)), InvalidTitle
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "\t\v", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500)), InvalidTitle
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "", pr, 100, AbstractGame::Average, 3, 100, 200, true, 5, 0), InvalidTitle
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "  ", pr, 100, AbstractGame::Average, 3, 100, 200, true, 5, 0), InvalidTitle
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "\t\v", pr, 100, AbstractGame::Average, 3, 100, 200, true, 5, 0), InvalidTitle
        );

        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 0, AbstractGame::Average, 3, 100, 200, true, Price(500)), InvalidFilesSize
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 0, AbstractGame::Average, 3, 100, 200, true, 5, 0), InvalidFilesSize
        );

        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 0, 100, 200, true, Price(500)), InvalidMinTestersAmount
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 0, 100, 200, true, 5, 0), InvalidMinTestersAmount
        );

        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 0, 200, true, Price(500)), InvalidLength
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 0, 200, true, 5, 0), InvalidLength
        );

        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 300, 200, true, Price(500)), InvalidFullLength
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 300, 200, true, 5, 0), InvalidFullLength
        );

        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(-1)), InvalidPrice
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, -10), InvalidPrice
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, 5, -1), InvalidPrice
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, -1, 0), InvalidPrice
        );
        CHECK_THROWS_AS(
            RolePlayingGame(30001, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, -2, 150), InvalidPrice
        );
    }
    SECTION("Title setter - typical")
    {
        game.setTitle("ABC");
        CHECK(game.getId() == 30001);
    ...
    SECTION("<< operator")
    {
        ...
        RolePlayingGame game1(39000, "G", pr, 100, AbstractGame::Average, 3, 100, 200, true, Price(500));
        stream1.str("");
        stream1.clear();
        stream2.str("");
        stream2.clear();
