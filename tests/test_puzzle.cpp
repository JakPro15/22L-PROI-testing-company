...
{
    Producer pr;
    Puzzle game(20001, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(500));
    SECTION("Constructors and getters - typical")
    {
        // Construction from Price object
        Puzzle game1(20001, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(500));
        CHECK(game1.getId() == 20001);
        ...
        Puzzle game2(29999, "            TYYY", pr, 10000, AbstractGame::Complex, 1, Puzzle::Easy, false, 500);
        CHECK(game2.getId() == 29999);
        ...
        Puzzle game3(20001, "G a a", pr, 234, AbstractGame::Simple, 23, Puzzle::VeryDifficult, true, 5, 12);
        CHECK(game3.getId() == 20001);
    ...
    {
        CHECK_THROWS_AS(
            Puzzle(20000, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(500)), InvalidId
        );
        CHECK_THROWS_AS(
            Puzzle(20000, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(500)), InvalidId
        );
        CHECK_THROWS_AS(
            Puzzle(30000, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, 5, 0), InvalidId
        );
        CHECK_THROWS_AS(
            Puzzle(30000, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, 5, 0), InvalidId
        );
        ...
        CHECK_THROWS_AS(
            Puzzle(20001, "", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(500)), InvalidTitle
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "  ", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(500)), InvalidTitle
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "\t\v", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(500)), InvalidTitle
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, 5, 0), InvalidTitle
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "  ", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, 5, 0), InvalidTitle
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "\t\v", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, 5, 0), InvalidTitle
        );

        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 0, AbstractGame::Average, 3, Puzzle::Average, true, Price(500)), InvalidFilesSize
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 0, AbstractGame::Average, 3, Puzzle::Average, true, 5, 0), InvalidFilesSize
        );

        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 100, AbstractGame::Average, 0, Puzzle::Average, true, Price(500)), InvalidMinTestersAmount
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 100, AbstractGame::Average, 0, Puzzle::Average, true, 5, 0), InvalidMinTestersAmount
        );

        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, Price(-1)), InvalidPrice
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, -10), InvalidPrice
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, 5, -1), InvalidPrice
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, -1, 0), InvalidPrice
        );
        CHECK_THROWS_AS(
            Puzzle(20001, "G", pr, 100, AbstractGame::Average, 3, Puzzle::Average, true, -2, 150), InvalidPrice
        );
    }
    SECTION("Title setter - typical")
    {
        game.setTitle("ABC");
        CHECK(game.getId() == 20001);
    ...
    SECTION("<< operator")
    {
        ...
        Puzzle game1(29000, "G", pr, 100, AbstractGame::Average, 3, Puzzle::VeryDifficult, true, Price(500));
        stream1.str("");
        stream1.clear();
        stream2.str("");
        stream2.clear();
