...
protected:
    // Returns the unique name of the puzzle (for example "RolePlayingGame 1", if id==30001).
...
public:
    ...
    friend std::ostream& operator<<(std::ostream &stream, const RolePlayingGame &game);
};
