...
#include "../../testingcompany/abstractworker.h"
#include "../../testingcompany/tester.h"
#include <vector>

TestingCompany::TestingCompany(TestingDatabase& database, OutputHandler& out,
    std::vector<std::shared_ptr<AbstractWorker>> workers,
    std::vector<std::shared_ptr<Tester>> testers):
    effort(0), currentRequestId(11000001), database(database), records{}, workers{workers}, testers{testers}, out(out)
{}
